...
const socialIcons = [
  { icon: <FaGithub />, link: "https://github.com/SamAbhishek7" },
  { icon: <FaLinkedin />, link: "https://www.linkedin.com/in/sam-abhishek/" },
  { icon: <FaEnvelope />, link: "mailto:samabhishek2605@gmail.com" },
];
  ...
  <footer className="mt-10 relative">
    <div className="flex flex-col items-center">
      ...
      <div className="text-xs dark:text-white font-semibold py-3 text-center">
        <p>© {new Date().getFullYear()} Sam Abhishek. Built with ❤️ using React.</p>
      </div>
    </div>
  </footer>
);
